    ...
    <>
      <div className=" bg-white flex justify-between h-42">
        <div className="flex ml-22">
          ...
          />
          <div className=" w-103 mb-5 flex justify-center mt-_5 font-avenir-reg font-medium text-base text-secondary uppercase leading-54 tracking-wider ml-10 ">
            Product
          </div>
        </div>
        <div className="w-103 flex justify-center mt-_5 font-avenir-reg font-medium text-base text-secondary uppercase leading-54 tracking-wider mr-45">
          Typology
        </div>
        <div className="w-51 flex justify-center mt-_5 font-avenir-reg font-medium text-base text-secondary uppercase leading-54 tracking-wider mr-50">
          Cost
        </div>
        <div className="w-138 flex justify-center mt-_5 font-avenir-reg font-medium text-base text-secondary uppercase leading-54 tracking-wider mr-30">
          Cost Markup
        </div>
        <div className="w-51 mr-130 flex justify-center mt-_5 font-avenir-reg font-medium text-base text-secondary uppercase leading-54 tracking-wider">
          Price
        </div>
      </div>
      ...
      <div className=" flex justify-between">
        ...
        <div className="w-134 ml-80 mt-8 font-nunito-normal font-light text-base leading-22 text-black">
          6X4(15X10cm)
        </div>

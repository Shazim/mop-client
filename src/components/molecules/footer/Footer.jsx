        ...
        <div>
            ...
            <div className="bg-gray">
                <div className="max-screen pl-147 pr-100 flex flex-row pt-75 pb-75">
                    <div className="w-1/4">
                        <Logo className="w-130 h-32" />
                    </div>
                    <div className="w-3/4 flex flex-row">
                        <div className='w-1/4 pl-40'>
                            <div className="text-primary font-bold text-sm tracking uppercase mb-40">create a gallery</div>
                        ...
                        <div className='w-1/4 pl-40'>
                            <div className="text-primary font-bold text-sm tracking uppercase mb-40">browser</div>
                        ...
                        <div className='w-1/4 pl-40'>
                            <div className="text-primary font-bold text-sm tracking uppercase mb-40">Store</div>
                            <div className="footer-links">Stockroom</div>
                            <div className="footer-links">Orders</div>
                            <div className="footer-links">Checkout</div>
                        </div>
                        <div className='w-1/4 pl-40'>
                            <div className="text-primary font-bold text-sm tracking uppercase mb-40">contact</div>
            ...
            <div className="bg-secondary">
                <div className="max-screen flex flex-row text-white pl-147 pr-175 pt-38 pb-38">
                    <div className="w-1/2">
                        <div className="mb-8 text-base font-medium font-semibold ">&copy; Masters Of Photography 2021</div>
                        <div className="flex flex-row items-center">
                            <div className="mr-45 text-sm font-bold uppercase tracking">Privacy Policy</div>
                            <div className="text-sm font-bold uppercase tracking">Terms & Conditions</div>
                        </div>
                    </div>
                    <div className="w-1/2 flex flex-row justify-end items-center">
                        <Twitter className="w-22 h-22 mr-22" />
                        <Facebook className="w-22 h-22 mr-22" />
                        <Instagram className="w-22 h-22 mr-22" />
                        <Youtube className="w-22 h-22" />
                    </div>
                </div>

            ...
            >
                <div className='bg-gray-lighter w-568 pl-56 pr-57 py-40'>
                    <Form 
                        ...
                        validationSchema={generateSchema({email: '', password: '', confirm: ''})}
                        >
                        ...
                        <div className='w-100% border-b border-border opacity-1 pb-33 pt-10 mb-33'>
                            ...
                            <TextField
                                ...
                                height="38" 
                                label="Email Address" />
                                <div className='font-avenir-reg text-base text-primary'>{error}</div>
                            <TextField 
                                name="password"
                        ...
                        <SubmitButton className='w-42% h-41 flex tracking font-bold text-sm justify-center items-center mx-auto mt-12'>SIGN UP</SubmitButton>
                        <div className='flex justify-between pr-20 mt-14'>
                            <div
                                onClick={signInModal} 
                                className='font-bold text-primary text-sm uppercase tracking leading-32 link underline'>login</div>
                            <div
                                onClick={forgotModal} 
                                className='font-bold text-primary text-sm uppercase tracking leading-32 link underline'>forgot password</div>
                        </div>
                    </Form>
                </div>
            </Modal>

...
function SinglePhoto() {
  return (
    <>
      ...
      <div className="max-screen flex w-100% pt-115 sm:bg-gray-dark sm:flex-col sm:px-23">
        <div className="w-50% md:w-45% sm:w-100% ">
        ...
        <div className="w-50% md:w-55% flex justify-end sm:w-100% sm:bg-white">
          <AddCart />
        </div>
      </div>

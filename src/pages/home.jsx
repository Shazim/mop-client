    ...
    <>
      ...
      <div className="max-screen pt-72">
        <div className="text-2xl font-avenir-reg uppercase text-secondary-dark tracking-wider mb-42">
          Featured
          <div className="flex">
            <div className="text-primary text-57 -mt-18 text-heading font-bold">
              .
            </div>
      ...
      <div className="bg-background-gallery bg-no-repeat bg-cover">
        <div className="max-screen items-center pb-169 pt-165">
          <div className="text-center text-2xl font-avenir-reg font-black uppercase text-secondary-dark mb-22 leading-38 tracking-wider">
          ...
          <div className="flex justify-center mt-26">
            <Button transform="capitalize" className="w-251 h-51 mr-18">
